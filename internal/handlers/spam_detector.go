...
Ecли зaинтepecoвaлo пишитe нa мoй aкк >>> @Alex51826.</message>
<response>SPAM</response>
</example>
...
WhatsApp +999 599 099 567</message>
<response>NOT_SPAM</response>
</example>
...
*⃣Дoxoднocть чиcтaя в дeнь paвняeтcя oт 7-9 пpoцeнтoв.
*⃣БECПЛAТHOE OБУЧEHИE, мoй интepec пpoцeнт oт зapaбoткa. 💶
Ecли зaинтepecoвaлo пишuте нa мoй aкк >>> @Alex51826.</message>
<response>SPAM</response>
</example>
...
<example>
<message>Ночью с 12 на 13 ноября еду из аэропорта Кутаиси до Батуми. Возьму за бензин. Кому интересно пишите в ЛС.</message>
<response>NOT_SPAM</response>
</example>

<example>
<message>Купите в зумере, съездите в сарпи, tax free, заберите 11% с покупки и вуаля, норм цена</message>
<response>NOT_SPAM</response>
</example>
...
<example>
<message>Всем кoму интереcно имeть xороший cтабильный доxод на yдаленке cо свободной занятостью , ждy в лc.</message>
<response>SPAM</response>
</example>

<example>
<message>Хай. Устали от быстрого заpаботка и пустых обещаний? Давайте лучше рaботать с реальными резyльтатами. Мы предлагаем стабильнoе нaправление, где можно полyчать от 800 дoлларов в неделю с отличной перcпективой ростa. Пишите плюс в личные сообщения и я дам всё необходимое</message>
<response>SPAM</response>
</example>
</examples>`
