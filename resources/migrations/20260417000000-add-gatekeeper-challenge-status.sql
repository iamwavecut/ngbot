...
CREATE INDEX IF NOT EXISTS idx_gatekeeper_challenges_chat_user
ON gatekeeper_challenges(chat_id, user_id);

-- +migrate Down
DROP INDEX IF EXISTS idx_gatekeeper_challenges_chat_user;
